...
The supplier provides an application that allows the client to access the weather data.
...
To support the development and implementation as well as continued operation of the service, The supplier offers the following services:
